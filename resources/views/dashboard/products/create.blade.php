        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <form action="{{ route('dashboard.products.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select name="category_id" class="form-control">
                            ...
                            @foreach ($categories as $category)
                                <option name ="category_id"value="{{ $category->id }}" {{ old('category_id') == $category->id ? 'selected' : '' }}>{{ $category->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        <img src="{{ asset('uploads/productsImages/default.png') }}" style="width: 100px" class="img-thumbnail image-preview" alt="">
                    </div>
